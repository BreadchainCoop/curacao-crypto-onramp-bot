...
1. Confirm the solution is implemented or otherwise supported by repository
   evidence.
...
4. Remove secrets, personal data, transient logs, and machine-specific details.
5. Link the note from agent guidance only when it represents a broad rule.
